...
def visualize(temporal_networks,
    ...
    for itn, tn in enumerate(temporal_networks):
        ...
        tn_b = _get_prepared_network(tn, frame_dt, new_time_unit, time_normalization_factor)
...
if __name__ == "__main__":
    ...
    visualize(a,frame_dt = 20,titles = 'HT09',new_time_unit='h',time_normalization_factor=1./3600.)
